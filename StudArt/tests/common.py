...
class APIFactoryTestCase(APITestCase):
	...
	def setUpTestData(cls):
		...
		CommentModel.objects.create(text='Some comment 2.1', author=UserModel.objects.get(username='User2'), comment=CommentModel.objects.get(text='Some comment 1'))
		CommentModel.objects.create(text='Some comment 2.2', author=UserModel.objects.get(username='User2'), comment=CommentModel.objects.get(text='Some comment 1'))
		CommentModel.objects.create(text='Some comment 2.3', author=UserModel.objects.get(username='User2'), comment=CommentModel.objects.get(text='Some comment 1'))
		...
		CommentModel.objects.create(text='Some comment 8', author=UserModel.objects.get(username='User'), artwork=ArtworkModel.objects.get(description='Some description 18'))
